...
import com.example.sensorclient.dto.MeasurementDTO;
import com.example.sensorclient.dto.MeasurementsResponse;
...
public class DrawChart {
    ...
    private static void drawChart(List<Double> temperatures) {
        ...
        XYChart chart = QuickChart.getChart("Temperatures",
                "Measurement Number", "Degrees", "temperature", xData, yData);
